FROM registry.fedoraproject.org/fedora:43@sha256:133f753148b36153f08294ae6506df2219731170644decbea1e1fbc0df0f6f8e
...
ADD python_scripts/gather-rpms.py /usr/local/bin
ADD python_scripts/gen_ancestors_from_src.py /usr/local/bin
ADD python_scripts/sbom_utils.py /usr/local/bin
